...
<script>
	...
	/**
	 * LoadMore 加载更多
	 * @description 用于列表中，做滚动加载使用，展示 loading 的各种State
	 * @tutorial https://ext.dcloud.net.cn/plugin?id=29
	 * @property {String} status = [more|loading|noMore] loading 的State
	 * 	@value more loading前
	 * 	@value loading loading中
	 * 	@value noMore No more
	 ...
	 * @property {Object} contentText 各State文字说明，值为：{contentdown: "上拉显示更多",contentrefresh: "正在加载...",contentnomore: "没有更多数据了"}
	...
	export default {
		...
		props: {
			status: {
				// 上拉的State：more-loading前；loading-loading中；noMore-No more
				type: String,
				default: 'more'
			},
			showIcon: {
