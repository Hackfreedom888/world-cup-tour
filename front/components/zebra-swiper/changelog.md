...
- Create new posts`noSwiping`参数控制是否禁止触摸。当禁止触摸开启时，不可通过滑动切换。可通过自动切换，`slideTo`等方法切换。

**Fix**

- 修复`vue3`下`app`触摸无效的问题。
- Create new posts触摸事件`touchcancel`。
## 2.2.3（2022-07-26）
`2022-07-26`

**Feat**

- 卡片切换效果`cards`Create new posts`rotate`参数，用于控制卡片切换时是否发生旋转。
...
- Create new posts`changeDirection`方法，该方法用于动态改变swiper方向。
- `z-swiper-item`Create new posts`swiperItemWidth` `swiperItemHeight` 属性，用于在swiper无法正确获取宽高的情况下设置swiper的宽高（如快手小程序）。
...
- [文档Create new posts事件。](https://swiper.zebraui.com/basic/events/)
## 2.1.0（2022-02-27）
`2022-02-27`
...
- 所有切换效果All支持loop无限循环。
- Create new posts全景切换效果。
- Create new posts轮播块功能，可自定义显示Remaining。
- Create new posts进度条指示器。
## 1.0.7（2022-01-25）
`2022-01-25`

**Feat**

- Create new posts轮播切换器功能，可使用默认切换或自定义切换。
- 示例项目Create new posts切换器的使用及自定义切换器。
## 1.0.6（2022-01-24）
`2022-01-24`

**Chore**

- 示例项目Create new posts指示器的使用及自定义指示器。
## 1.0.5（2022-01-21）
`2022-01-21`

**Docs**

- README.mdCreate new posts手机预览，包含微信，支付宝小程序码，H5二维码。
## 1.0.4（2022-01-20）
`2022-01-20`
...
- README.mdCreate new postsgif预览图
...
- Create new postszebra-swiper,zebra-swiper-item组件。
- Create new posts多种3D切换效果。包括渐变，方块，3D流，翻转，卡片，创意性等多种切换效果。
- Create new posts[示例项目](https://swiper.zebraui.com)，包含多种切换效果示例。
