...
public class BanzhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		if(u==null || !u.getMima().equals(password)) {
			return R.error("账号或Password不正确");
		}
		String token = tokenService.generateToken(u.getId(), username,"banzhu",  "Administrator" );
    ...
    public R query(BanzhuEntity banzhu){
		...
		return R.ok("SearchModerator成功").put("data", banzhuView);
    }
