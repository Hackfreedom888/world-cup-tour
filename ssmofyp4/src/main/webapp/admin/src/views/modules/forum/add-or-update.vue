<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Post title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="Post title" clearable  :readonly="ro.title"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="Post title" prop="title">
					<el-input v-model="ruleForm.title" placeholder="Post title" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="State" prop="isdone">
					<el-select :disabled="ro.isdone" v-model="ruleForm.isdone" placeholder="请选择State" >
						<el-option
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="State" prop="isdone">
					<el-input v-model="ruleForm.isdone"
						placeholder="State" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="帖子Content" prop="content">
					<editor 
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="帖子Content" prop="content">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				content: [
					{ required: true, message: '帖子Content不能为空', trigger: 'blur' },
				],
				parentid: [
				],
				userid: [
	...
	this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../ssmofyp4/upload');
        } else {
