	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Customer" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Customer" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="Customer" prop="name">
					<el-input v-model="ruleForm.name" placeholder="Customer" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Contact" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="Contact" clearable  :readonly="ro.phone"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="Contact" prop="phone">
					<el-input v-model="ruleForm.phone" placeholder="Contact" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="是否默认Address[是/否]" prop="isdefault">
					<el-input v-model="ruleForm.isdefault" placeholder="是否默认Address[是/否]" clearable  :readonly="ro.isdefault"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"33.3%","margin":"0 0 20px 0"}' v-else class="input" label="是否默认Address[是/否]" prop="isdefault">
					<el-input v-model="ruleForm.isdefault" placeholder="是否默认Address[是/否]" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				name: [
					{ required: true, message: 'Customer不能为空', trigger: 'blur' },
				],
				phone: [
					{ required: true, message: 'Contact不能为空', trigger: 'blur' },
				],
				isdefault: [
					{ required: true, message: '是否默认Address[是/否]不能为空', trigger: 'blur' },
				],
			}
		};
	},
