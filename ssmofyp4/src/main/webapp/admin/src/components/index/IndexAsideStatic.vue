		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>Home page</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					...
					<el-menu-item index="1-1" @click="menuHandler('updatePassword')">ModifyPassword</el-menu-item>
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","margin":"0 0 4px","display":"none"}
