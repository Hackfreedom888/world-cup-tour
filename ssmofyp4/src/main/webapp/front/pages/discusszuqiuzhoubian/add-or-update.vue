	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusszuqiuzhoubian`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discusszuqiuzhoubian`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discusszuqiuzhoubian`, this.ruleForm);
						}else{
							await this.$api.add(`discusszuqiuzhoubian`, this.ruleForm);
						}
						uni.setStorageSync('discusszuqiuzhoubianCleanType',true);
