<template>
	<view class="content">
		<view class="row b-b">
			...
			<input class="input" type="text" v-model="addressData.name" placeholder="Customer姓名" placeholder-class="placeholder" />
		</view>
		<view class="row b-b">
			<text class="tit">手机号</text>
			<input class="input" type="number" v-model="addressData.phone" placeholder="Customer手机号码" placeholder-class="placeholder" />
		</view>
		<view class="row b-b">
			<text class="tit">Address</text>
            <input class="input" type="text" v-model="addressData.address" placeholder="Address" placeholder-class="placeholder" />
		</view>
		<!-- <view class="row b-b">
