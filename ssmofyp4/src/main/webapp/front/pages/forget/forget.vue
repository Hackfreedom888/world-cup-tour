	...
	<view class="content">
        ...
        <view class="box" :style='{"width":"100%","padding":"24rpx","backgroundSize":"100%","background":"url(http://codegen.caihongy.cn/20221109/ea2d226d42fe495daff146c9b99f4f24.jpg) center top  no-repeat","height":"100vh"}' v-if="type==2">
            <view :style='{"width":"70%","padding":"24rpx","margin":"120rpx 0 0 0","display":"block","height":"auto"}'>
                ...
                <view class="forget-input" :style='{"width":"100%","margin":"0 0 24rpx 0","borderColor":"#dcdae5","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"auto"}'>
                    <input v-model="userForm.panswer1" :style='{"border":"0px solid rgb(255, 170, 51)","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","background":"none","width":"100%","fontSize":"28rpx","height":"88rpx"}' type="text" placeholder="密保答案" />
                </view>
        ...
        <view class="box" :style='{"width":"100%","padding":"24rpx","backgroundSize":"100%","background":"url(http://codegen.caihongy.cn/20221109/ea2d226d42fe495daff146c9b99f4f24.jpg) center top  no-repeat","height":"100vh"}' v-if="type==3">
            <view :style='{"width":"70%","padding":"24rpx","margin":"120rpx 0 0 0","display":"block","height":"auto"}'>
                <view class="forget-input" :style='{"width":"100%","margin":"0 0 24rpx 0","borderColor":"#dcdae5","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"auto"}'>
                    <input v-model="userForm.password" :style='{"border":"0px solid rgb(255, 170, 51)","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","background":"none","width":"100%","fontSize":"28rpx","height":"88rpx"}' type="password" placeholder="Password" />
                </view>
                <view class="forget-input" :style='{"width":"100%","margin":"0 0 24rpx 0","borderColor":"#dcdae5","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"auto"}'>
                    <input v-model="userForm.repassword" :style='{"border":"0px solid rgb(255, 170, 51)","padding":"0px 24rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","background":"none","width":"100%","fontSize":"28rpx","height":"88rpx"}' type="password" placeholder="Confirm" />
                </view>
                <button class="landing" :style='{"border":"0","padding":"0px","margin":"24rpx 0 24rpx 0","color":"rgb(255, 255, 255)","borderRadius":"8rpx","background":"url(http://codegen.caihongy.cn/20221108/9576aabc35484eca94c43b91cc41cced.png) no-repeat","width":"478rpx","lineHeight":"88rpx","fontSize":"32rpx","backgroundSize":"100% 100%","height":"88rpx"}' @tap="updateClick" type="primary">ModifyPassword</button>
            </view>
        </view>
	</view>
</template>
		...
		methods: {
			async nextClick() {
				if(this.username==undefined) {
					this.$utils.msg('Please input account')
					return;
                                }
            ...
            async updateClick() {
                ...
                this.$utils.msg('PasswordModify成功')
                setTimeout(() => {
                    uni.navigateBack({
