<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
				...
				<view class="listmr">
					...
					<view class="flex flex-align-center mt20">
						<view class="colb f25">
							...
							<button style="margin-left: 20upx;" @tap="onUpdateTap(item.id)" class="cu-btn bg-blue shadow">Modify</button>
							<button style="margin-left: 20upx;" @tap="onDeleteTap(item.id)" class="cu-btn bg-red shadow">Delete</button>
						</view>
					</view>
				</view>
			</view>
		...
		<!--list end-->
		<button class="add-btn" @click="onUpdateTap()">Add</button>
	</mescroll-uni>
</template>
