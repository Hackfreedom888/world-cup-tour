	...
	<view class="content">
		<view v-if="!changeSuccess">
			<view class="uni-form-item uni-column">
				<input v-model="money" type="number" class="uni-input" name="" placeholder="请输入要充值的Number" />
			</view>
			<button type="primary" @tap="onResetPass">submit</button>
		</view>
		<view v-if="changeSuccess">
			<view class="text-reset">充值成功！</view>
			<button type="primary" @tap="back">Return</button>
		</view>
	</view>
</template>
