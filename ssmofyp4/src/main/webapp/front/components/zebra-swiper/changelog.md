...
- Add`noSwiping`参数控制是否禁止触摸。当禁止触摸开启时，不可通过滑动切换。可通过自动切换，`slideTo`等方法切换。
...
- 卡片切换效果`cards`Add`rotate`参数，用于控制卡片切换时是否发生旋转。
...
- Add`changeDirection`方法，该方法用于动态改变swiper方向。
- `z-swiper-item`Add`swiperItemWidth` `swiperItemHeight` 属性，用于在swiper无法正确获取宽高的情况下设置swiper的宽高（如快手小程序）。
...
本次改版涉及所有开启loop的功能。请更新后Delete手动拼接的数据。
...
- 修复字节小程序轮播Content不显示的问题。
- 修复字节小程序获取位置信息错误的问题。

**Docs**

- [文档Add事件。](https://swiper.zebraui.com/basic/events/)
## 2.1.0（2022-02-27）
`2022-02-27`
...
这个Operation也为swiper接管数据Operation铺垫，对后续很多新功能非常有用，也为loop无限循环的痛点提供了解决方案。
...
- Add轮播切换器功能，可使用默认切换或自定义切换。
- 示例项目Add切换器的使用及自定义切换器。
## 1.0.6（2022-01-24）
`2022-01-24`

**Chore**

- 示例项目Add指示器的使用及自定义指示器。
## 1.0.5（2022-01-21）
`2022-01-21`

**Docs**

- README.mdAdd手机预览，包含微信，支付宝小程序码，H5二维码。
## 1.0.4（2022-01-20）
`2022-01-20`

**Style**

- 示例项目Home pagepx统一Modify为rpx。
## 1.0.3（2022-01-19）
`2022-01-19`
...
- Addzebra-swiper,zebra-swiper-item组件。
- Add多种3D切换效果。包括渐变，方块，3D流，翻转，卡片，创意性等多种切换效果。
- Add[示例项目](https://swiper.zebraui.com)，包含多种切换效果示例。
